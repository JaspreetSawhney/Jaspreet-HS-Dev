<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="HairSlayer.Search" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register TagPrefix="uc1" TagName="RImage" Src="~/UserControls/RateImage.ascx" %>
...
<body>
    ...
    <div id="login_popup">
        ...
        <asp:TextBox ID="password_login" runat="server"></asp:TextBox><br /><br />
    ...
    <div id="wrapper">
        ...
        <div id="content_wrap"> 
            ...
            <asp:Label ID="RowsReturned" Visible="false" Font-Size="24px" runat="server" Text=""></asp:Label>
            <span style="margin-left: 200px;">
                    <asp:LinkButton ID="AllStyles" runat="server" Visible="false" onclick="AllStyles_Click">All Styles</asp:LinkButton> &nbsp; &nbsp; &nbsp;
                    <asp:LinkButton ID="Male" runat="server" Visible="false" onclick="Male_Click">Male</asp:LinkButton> &nbsp; &nbsp; &nbsp;
                    ...
                    <asp:LinkButton ID="Female" Visible="false" runat="server" onclick="Female_Click">Female</asp:LinkButton>
            ...
            <asp:PlaceHolder ID="SearchGrid" runat="server"></asp:PlaceHolder>
            <asp:Label ID="Search_Grid" runat="server" Text=""></asp:Label>
        </div>
