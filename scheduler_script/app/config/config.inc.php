...
if (!$stop)
{
	...
	{
		# LOCAL
		define("DEFAULT_HOST",   "10.80.65.195");
		define("DEFAULT_USER",   "hslayer_admin");
		define("DEFAULT_PASS",   "diM_3281@99");
		define("DEFAULT_DB",     "a_shed");
	...
	if ($_SERVER['SERVER_ADDR'] == '127.0.0.1')
	{
		...
		if (!defined("INSTALL_PATH")) define("INSTALL_PATH", "C:/inetpub/wwwroot/hairslayer.com/script/");
		if (!defined("INSTALL_URL")) define("INSTALL_URL", "http://50.56.182.191/script/");
	} else {
		if (!defined("BASE_PATH")) define("BASE_PATH", "http://" . $_SERVER['SERVER_NAME'] . "/script/");
		if (!defined("INSTALL_FOLDER")) define("INSTALL_FOLDER", "/script/");
		if (!defined("INSTALL_PATH")) define("INSTALL_PATH", "C:/inetpub/wwwroot/hairslayer.com/script/");
