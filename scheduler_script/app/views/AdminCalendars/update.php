...
if (isset($tpl['status']))
{
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1"><?php echo $SBS_LANG['calendar_update']; ?></a></li>
		</ul>
		<div id="tabs-1">
		
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=AdminCalendars&amp;action=update&amp;id=<?php echo $tpl['arr']['id']; ?>" method="post" id="frmCreateCalendar" class="ebc-form">
				<input type="hidden" name="calendar_update" value="1" />
				<input type="hidden" name="id" value="<?php echo $tpl['arr']['id']; ?>" />
				
				<p><label class="title"><?php echo $SBS_LANG['calendar_title']; ?>:</label><input type="text" name="calendar_title" id="calendar_title" class="text w500 required" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['calendar_title'])); ?>" /></p>
