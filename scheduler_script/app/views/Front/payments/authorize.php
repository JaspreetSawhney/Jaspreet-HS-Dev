...
$x_description  = !empty($tpl['arr']['detail_str']) ? htmlspecialchars($tpl['arr']['detail_str']) : 'Service Booking';
...
?>
<form method="post" action="<?php echo $url; ?>" style="display: inline" name="SBScript_FormAuthorize_<?php echo $_REQUEST['cid']; ?>">
