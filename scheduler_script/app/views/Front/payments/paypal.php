...
/**
 * @package ebc
 * @subpackage ebc.app.views.Front.payments
 */
$url = TEST_MODE ? 'https://sandbox.paypal.com/cgi-bin/webscr' : 'https://www.paypal.com/cgi-bin/webscr';
?>
<form action="<?php echo $url; ?>" method="post" style="display: inline" name="SBScript_FormPaypal_<?php echo $_REQUEST['cid']; ?>">
	<input type="hidden" name="cmd" value="_xclick" />
	<input type="hidden" name="business" value="<?php echo $tpl['option_arr']['paypal_address']; ?>" />
	<input type="hidden" name="item_name" value="<?php echo !empty($tpl['arr']['detail_str']) ? htmlspecialchars($tpl['arr']['detail_str']) : 'Service Booking'; ?>" />
