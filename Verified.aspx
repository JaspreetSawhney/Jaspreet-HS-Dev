<%@ Page Title="HairSlayer.com - Verified" Language="C#" MasterPageFile="~/Header.Master"
    AutoEventWireup="true" CodeBehind="Verified.aspx.cs" Inherits="HairSlayer.Verified" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainBody" runat="server">
    ...
    <div class="body-section">
        ...
        <div class="left-column floating-left">
            ...
            <div class="heading">
                <h1 class="floating-left"><asp:Label ID="lblverified" runat="server" ></asp:Label>
               </h1> <div class="select-style floating-right">
                    <ul>
<%--                        <li><asp:LinkButton ID="AllStyles" runat="server" onclick="AllStyles_Click">All Styles</asp:LinkButton></li>
            ...
            <div class="rating-container rounded-corners">
                ...
                <h2 style="width: 175px; margin-bottom: 4px;">   <asp:Label ID="doname1" runat="server"></asp:Label></h2>
                <div class="cleared"></div>
