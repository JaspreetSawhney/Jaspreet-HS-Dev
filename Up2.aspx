<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Up2.aspx.cs" Inherits="HairSlayer.Up2" %>
...
<body>
    ...
    <div id="main">         
     ...
     <asp:Panel ID="pnlCrop" Visible="false" runat="server">
        ...
        <asp:Button ID="ReUpload" runat="server" Visible="false" CssClass="site-button" 
             Text="Upload Photo Again" onclick="ReUpload_Click" />
        <asp:Button ID="btnSave" runat="server" Visible="false" CssClass="site-button" 
             Text="Save Image" onclick="btnSave_Click" />
         
     </asp:Panel>
        <asp:TextBox ID="loc" Width="1px" ForeColor="#FFFFFF" BorderColor="#FFFFFF" runat="server"></asp:TextBox>
     <asp:HiddenField ID="tmp_fle" runat="server" />
     <asp:HiddenField ID="fle_id" runat="server" />
     <script>
         //document.getElementsByName('tmp_fle').value = 'Show';
         //document.write(document.getElementsByName('tmp_fle').value);
         //document.getElementsByName('loc').value = 'Show';
         //document.write(document.getElementsByName('loc').value);
         //document.getElementById('loc').value = "Testing";


         /*jQuery(document).ready(function () {
             jQuery('#loc').val('Show Me!');
             });*/
