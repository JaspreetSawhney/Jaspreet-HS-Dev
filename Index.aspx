<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="HairSlayer.Index" %>
...
<body>
    ...
    <div id="refer-friend-pop">
        <div id="close-pop-div"><a href="" class="close-pop">X Close Window</a></div>
        <iframe src="http://vouchfor.com/Hair-Slayer/?vouchCount=2" width="100%" height="100%"></iframe>
    </div>

    <div id="press-pop">
        <div id="close-press-div"><a href="" class="close-press">X Close Window</a></div>
        <!-- <iframe src="http://hairslayer.totemapp.com/company" width="100%" height="100%"></iframe> -->
    </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div id="content_wrap">
                    ...
                    <br>
                    <div id="filter-links">
                        <asp:LinkButton ID="AllStyles" CssClass="all-filter" runat="server" onclick="AllStyles_Click">All Styles</asp:LinkButton><asp:LinkButton ID="Male" CssClass="male-filter" runat="server" onclick="Male_Click">Male</asp:LinkButton><asp:LinkButton ID="Female" CssClass="female-filter" runat="server" onclick="Female_Click">Female</asp:LinkButton>
                    </div>
                ...
                <div id="sidebar_home">
                    <div id="sidebar_wrap">
                    <a href="#" class="refer-pop">Refer Your Stylist/Barber. Get $10</a>
                    <div class="cleared">&nbsp;</div>
